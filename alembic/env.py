...
from app.entities.stop.models import Stop
...
from app.entities.user.models import Base as UserBase
target_metadata = [Base.metadata, CarBase.metadata, StopBase.metadata, TripBase.metadata, UserBase.metadata]
"""
